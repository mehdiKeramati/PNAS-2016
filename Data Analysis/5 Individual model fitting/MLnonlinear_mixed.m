...
function params = MLnonlinear()
    ...
    ub = [beta1_UB ; beta2_UB ; alphaMF_UB ; driftMF_UB ; alphaMB_UB ; stayBias_UB ; W1_MB_Tr_UB ; W2_MB_UB];
...
%        [x,val,exitflag,output,lambda,grad,hessian] = fmincon(@negLogLikelihood,initialParam,[],[],[],[],lb,ub);
        ...
        disp('-----------------------------------------------------------');
        disp(['Transfer weight   = ',num2str(x(7)),'   sigma^2 = ',num2str(sigma2(7,7))]);
        disp(['Beta level 1      = ',num2str(x(1)),'   sigma^2 = ',num2str(sigma2(1,1))]);
        disp(['Alpha MF          = ',num2str(x(3)),'   sigma^2 = ',num2str(sigma2(3,3))]);
        disp(['Alpha MB          = ',num2str(x(5)),'   sigma^2 = ',num2str(sigma2(5,5))]);
        disp(['Stay bias         = ',num2str(x(6)),'   sigma^2 = ',num2str(sigma2(6,6))]);
        disp(['Drift MF          = ',num2str(x(4)),'   sigma^2 = ',num2str(sigma2(4,4))]);
        disp(['Beta level 2      = ',num2str(x(2)),'   sigma^2 = ',num2str(sigma2(2,2))]);
        disp(['Level-2 MB weight = ',num2str(x(8)),'   sigma^2 = ',num2str(sigma2(8,8))]);
        disp('-----------------------------------------------------------');
        ...
        params( subject-fromSubject+1 , 6 )= x(4);
        params( subject-fromSubject+1 , 7 )= x(2);
        params( subject-fromSubject+1 , 8 )= x(8);
        params( subject-fromSubject+1 , 9 )= val;
