...
%##                                          
%##########################################################################
function behavior = agent(trialsNum,explorationRate,explorationRateLevel2,stayBias,learningRateMF,driftMF,learningRateRewardMB,learningRateTransitionMB,microAgentsWeights,hoppingTrialsMean,hoppingTrialsVariance);
